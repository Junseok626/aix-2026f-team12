...
|---|---|---|---|
| 사용자 Who | 한양대학교 학생 | 팀플 과제하는 학생 |  |
| 상황 When/Where | 수강신청 | 팀플 기여도를 정량화 하고 싶을 때 |  |
| 페인포인트 What — 무엇이 **얼마나** | 정보가 흩어져 있음(강의평, 필수이수과목 등) | 누가 얼마나 기여했는지 수치화가 필요함 |  |
| 성공 기준 Done | 한 화면에서 강의평가와 커리큘럼을 비교하며 강의 선택 가능 | 팀플이 완료되었을 때 기여도 산출 |  |
